...
const landingAnimOutline =
  'transition-all duration-motion ease-motion-emphasized will-change-transform hover:-translate-y-0.5 hover:border-slate-500 hover:bg-slate-800/55 hover:shadow-md hover:shadow-slate-400/25 dark:shadow-black/25 active:translate-y-0 active:scale-[0.98] motion-reduce:transition-colors motion-reduce:hover:translate-y-0 motion-reduce:hover:shadow-none motion-reduce:active:scale-100';
...
const mockChrome =
  'transition-all duration-motion ease-motion-emphasized hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-400/25 dark:shadow-black/55 hover:ring-1 hover:ring-white/[0.08] motion-reduce:transition-shadow motion-reduce:hover:translate-y-0';

const mockDot =
  'transition-transform duration-motion ease-motion-emphasized hover:scale-125 motion-reduce:hover:scale-100';

const mockUrlBar =
  'transition-all duration-motion ease-motion-emphasized hover:border-slate-300 dark:border-slate-600 hover:bg-surface-elevated/40 hover:text-slate-300';
...
const mockNavPill = (active) =>
  `shrink-0 cursor-default rounded-lg px-2 py-1 text-[9px] font-medium transition-all duration-motion ease-motion-emphasized hover:scale-105 sm:text-[10px] motion-reduce:hover:scale-100 ${
    active
      ? 'bg-surface-elevated text-slate-900 dark:text-white ring-1 ring-slate-600/50 hover:ring-accent/35'
      : 'text-slate-500 hover:bg-slate-800/60 hover:text-slate-300'
  }`;

const mockStatCard =
  'cursor-default rounded-xl border border-slate-200 dark:border-slate-800 bg-surface-card p-2 transition-all duration-motion ease-motion-emphasized hover:-translate-y-0.5 hover:border-slate-300 dark:border-slate-600 hover:shadow-md hover:shadow-slate-400/25 dark:shadow-black/30 sm:p-2.5 motion-reduce:transition-colors motion-reduce:hover:translate-y-0';

const mockRow =
  'cursor-default transition-all duration-motion ease-motion-emphasized hover:-translate-y-px hover:border-slate-300 dark:border-slate-600 hover:bg-surface-elevated/25 motion-reduce:hover:translate-y-0';
...
function PreviewChrome({ children, urlLabel }) {
  return (
    <div
      className={`overflow-hidden rounded-2xl border border-slate-200/80 dark:border-slate-700/80 bg-surface shadow-2xl shadow-slate-400/25 dark:shadow-black/45 ring-1 ring-white/[0.06] ${mockChrome}`}
    >
      <div
    ...
    <div className="relative">
      <PreviewChrome urlLabel="ironlog · dashboard">
        <div className="p-3 sm:p-4">
          ...
          <p className="transition-colors duration-motion hover:text-accent-muted/90 text-xs font-semibold text-slate-900 dark:text-white">
            Dashboard
          </p>
  ...
  return (
    <div className="relative">
      <PreviewChrome urlLabel="ironlog · plans">
        <div className="p-3 sm:p-4">
          <p className="text-xs font-semibold text-slate-900 dark:text-white transition-colors duration-motion hover:text-accent-muted/90">
            Templates
          </p>
          <p className="text-[10px] text-slate-500 transition-colors duration-motion hover:text-slate-400">
          ...
          <ul className="mt-3 space-y-2">
            {['Strength — upper', 'Volume — lower', 'Deload week'].map((name) => (
              ...
              >
                <span className="min-w-0 truncate text-[11px] font-medium text-slate-900 dark:text-white transition-colors duration-motion hover:text-slate-100">
                  {name}
                </span>
                <span
    ...
    <div className="min-h-screen bg-surface text-slate-900 dark:text-slate-100">
      ...
      <main>
              ...
              <div className="min-w-0">
                ...
                <div className={`mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center ${enter} [animation-delay:280ms]`}>
                  ...
                  <button
                    type="button"
                    onClick={() => setAuthModal('login')}
                    className={`inline-flex min-h-12 w-full items-center justify-center rounded-xl border border-slate-300 dark:border-slate-600 bg-surface-card/50 px-6 text-sm font-medium text-slate-200 sm:w-auto ${landingAnimOutline}`}
                  >
                    Log in
                  </button>
                </div>
              ...
              {features.map(({ icon: Icon, title, body }, i) => (
                ...
                >
                  ...
                  <div className="min-w-0 pt-0.5">
                    <h3 className="font-semibold text-slate-900 dark:text-white transition-colors duration-motion group-hover:text-accent-muted/95">
                      {title}
                    </h3>
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div
              className={`relative overflow-hidden rounded-2xl border border-slate-200/80 dark:border-slate-700/80 bg-gradient-to-br from-surface-card via-surface-card to-slate-950/80 p-8 shadow-xl shadow-slate-400/25 dark:shadow-black/30 ring-1 ring-white/[0.04] transition-all duration-motion ease-motion-emphasized hover:border-slate-300/80 dark:border-slate-600/80 hover:shadow-2xl hover:shadow-slate-400/25 dark:shadow-black/40 sm:p-10 md:p-12 motion-reduce:hover:shadow-xl ${staggerClass(0, ctaVis)}`}
            >
              <div
              ...
              <div className="relative mx-auto max-w-xl text-center">
                ...
                <div className={`mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center sm:justify-center ${staggerClass(3, ctaVis)}`}>
                  ...
                  <button
                    type="button"
                    onClick={() => setAuthModal('login')}
                    className={`inline-flex min-h-12 items-center justify-center rounded-xl border border-slate-300 dark:border-slate-600 bg-transparent px-8 text-sm font-medium text-slate-200 ${landingAnimOutline}`}
                  >
                    I have an account
                  </button>
                </div>
